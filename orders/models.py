...
class Predpis(models.Model):
    ...
    """
    nazev = models.CharField(max_length=30, verbose_name='Název předpisu',)
    skupina = models.PositiveSmallIntegerField(verbose_name='Skupina TZ', blank=True, null=True)
    ohyb = models.CharField(max_length=30, verbose_name='Ohyb', blank=True, null=True)
    krut = models.CharField(max_length=30, verbose_name='Krut', blank=True, null=True)
    povrch = models.CharField(max_length=30, verbose_name='Povrch', blank=True, null=True)
    jadro = models.CharField(max_length=30, verbose_name='Jádro', blank=True, null=True)
    vrstva = models.CharField(max_length=30, verbose_name='Vrstva', blank=True, null=True)
    popousteni = models.CharField(max_length=30, verbose_name='Popouštění', blank=True, null=True)
    sarzovani = models.CharField(max_length=30, verbose_name='Šaržování', blank=True, null=True)
    pletivo = models.CharField(max_length=30, verbose_name='Pletivo', blank=True, null=True)
